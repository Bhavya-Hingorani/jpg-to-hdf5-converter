...
input_dir = 'D:/Attention OCR/jpg_to_h5/Input_dir'
output_dir = 'D:/Attention OCR/jpg_to_h5/Output_dir'
for filename in os.listdir('D:\Attention OCR\jpg_to_h5\Input_dir'):
    if filename[-4:] == '.jpg':
...
#     parser.add_argument('--input_dir', dest='D:\Attention OCR\jpg_to_h5\Input_dir', type=str,
#                     help='Input directory containing .jpg images')
#     parser.add_argument('--output_dir', dest='D:\Attention OCR\jpg_to_h5\Output_dir', type=str,
#                     help='Output directory containing .h5 images')
